...
const Blogs = () => {
    ...
    const handleDelete = async (id) => {
        const res = await fetch(`/api/blogs/blogDetails?blog_id=${id}`, {
            method: "DELETE",
            headers: {
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <div className="max-w-2xl mx-auto lg:max-w-none">
                        ...
                        <div className="mt-6 space-y-12 lg:space-y-0 lg:grid lg:grid-cols-3 lg:gap-x-6 lg:gap-y-6">
                            ...
                            {/* single blogs */}
                            {blogs.map((blog) => (
                                <div key={blog._id} className="group relative flex-col">
                                    ...
                                    <button onClick={()=>handleDelete(blog._id)}  className="bg-red-600 text-white p-3">Delete {blog?.title.slice(0,5)} blog </button>
                                </div>
                            ))}
                        </div>
                    </div>
