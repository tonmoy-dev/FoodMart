                    ...
                    <form action="">
                        <div className="mt-4">
                            ...
                            <div className="flex items-baseline justify-between">
                                <button className="px-6 py-2 mt-4 text-white bg-green-600 rounded-lg hover:bg-green-900">Login</button>
                                <a href="#" className="text-sm text-green-600 hover:underline">Forgot password?</a>
                            </div>
                            <div className="mt-4">
                                <p className="text-sm">Do not have an account? please </p> <a href="#" className="text-sm hover:text-sm text-green-600 hover:text-green-800 hover:underline">Sign up</a>
                            </div>
                        </div>
                    </form>
                </div>
