  ...
  <div className="container mx-auto flex px-5 py-24 md:flex-row flex-col items-center">
    ...
    <div className="lg:flex-grow md:w-1/2 lg:pl-24 md:pl-16 flex flex-col md:items-start md:text-left items-center text-center">
      <h1 className="title-font sm:text-4xl text-3xl mb-4 font-bold text-gray-900">Welcome to FoodMart</h1>
        ...
        <h2><span className='text-green-600 font-bold  '>What We Provide?</span></h2>
...
<br/>
Ius ferri velit sanctus cu, sed at soleat accusata. Dictas prompta et Ut placerat legendos interpre.Donec vitae sapien ut libero venenatis faucibus. Nullam quis ante Etiam sit amet orci eget. Quis commodo odio aenean sed adipiscing. Turpis massa tincidunt dui ut ornare lectus. Auctor elit sed vulputate mi sit amet. Commodo consequat.</p>
      <div className="flex  mx-0 justify-center">
        <button className="inline-flex text-white bg-green-600 py-2 px-6 border-0 focus:outline-none hover:bg-indigo-600 rounded text-lg">Get Booking</button>
