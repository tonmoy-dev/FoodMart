        ...
        <div>
            ...
            <div>
                <div>
                    ...
                    <div className='w-full min-h-screen  px-5 pb-5 pt-16'>

                        <div className="w-full mx-auto rounded-lg bg-white shadow-lg p-5">
                            <h1 className="my-2 font-bold text-center text-xl text-gray-700 uppercase ">Product List</h1>
                            <div className=' text-gray-700' action="">

                                <div className=' my-2 flex flex-col text-left '>
                                    {/* <h1>Payment</h1> */}
                                    {TotalProducts.map(product => {
                                        const { _id, product_badge, product_title, product_imageUrl, vendor_name, product_price } = product;

                                        return (<div key={_id}>
                                            <div key={_id} className='my-2 flex flex-row'>
                                                <Image src={product_imageUrl} width="80" height="80" alt="" />
                                                <div className="px-3">
                                                    <p>{product_title}</p>
                                                    <p>by <span className='text-green-600 font-bold'>{vendor_name}</span></p>
                                                    <p>price: <span className='text-orange-600 font-bold'>{product_price}</span> tk</p>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <Image src={product_imageUrl} width="50" height="50" />
                                    <div className="px-3">
                                        <p>{product_title}</p>
                                        <p>by <span className='text-green-600 font-bold'>{vendor_name}</span></p>
                                        <p>price: <span className='text-orange-600 font-bold'>{product_price}</span> tk</p>
                                ...
                                <div>
                                    <div>
                                        ...
                                        <h1 className="font-bold text-lg">
                                            Total: <span className="text-orange-500">{sum}</span> tk
                                        </h1>
