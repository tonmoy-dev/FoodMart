                    ...
                    {({ open }) => (
                        <>
                            ...
                            <div className="relative max-w-8xl mx-auto px-2 sm:px-6 lg:px-8">
                                <div className="relative flex items-center justify-between h-16 border-b border-gray-200">
                                        ...
                                        >
                                            <Menu.Items className="origin-top-right absolute right-0 mt-2 w-48 rounded-md shadow-lg py-1 bg-white ring-1 ring-black ring-opacity-5 focus:outline-none">
                                                <Menu.Item>
                                                    {
                                                        user?.email ? (
                                                            <p className="block px-4 py-2 text-sm text-gray-700">Hi! {user.displayName}</p>
                                                        ) : (
                                                            <p className="block px-4 py-2 text-sm text-gray-700">Welcome to FoodMart!</p>
                                                        )
                                                    }
                                                </Menu.Item>
                                                <Menu.Item>
