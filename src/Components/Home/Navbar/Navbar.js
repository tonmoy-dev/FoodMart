    ...
    return (
      <>
        <style jsx>{`
          ...
          #allCatagories:hover #catagoriesList {
            visibility: visible;
          }
        `}</style>
            ...
            <>
              <div className="max-w-8xl mx-auto px-2 sm:px-6 lg:px-8 shadow pb-3">
                ...
                <div className="relative flex items-center h-10 mt-4">
                  ...
                  <div
                    id="allCatagories"
                    className="transition bg-green-500 flex flex-row justify-between items-center cursor-pointer w-44 relative text-white px-4 rounded-t-lg py-2"
                  >
                    <MenuIcon className="w-5 h-5" />
                    <h1> All Catagories</h1>
                    <FiChevronDown className="pt-1 w-5 h-5" />
                    <div
                      id="catagoriesList"
                      className="bg-white rounded mt-10 top-0 h-auto py-4 invisible z-10 shadow-lg  absolute w-full left-0 text-black flex flex-col"
                    >
                      <div className="hover:bg-gray-100 flex items-center gap-2 hover:cursor-pointer pl-4 py-2">
                        <Image
                          width={30}
                          height={30}
                          src="https://i.ibb.co/yXGrSBh/cat5-25x25-crop-center.jpg"
                          alt=""
                        />
                        <span>Fruits</span>
                      </div>
                      <div className="hover:bg-gray-100 flex items-center gap-2 hover:cursor-pointer pl-4 py-2">
                        <Image
                          width={30}
                          height={30}
                          src="https://i.ibb.co/ZVJF7xP/cat7-25x25-crop-center.jpg"
                          alt=""
                        />
                        <span>Fruits</span>
                      </div>
                      <div className="hover:bg-gray-100 flex items-center gap-2 hover:cursor-pointer pl-4 py-2">
                        <Image
                          width={30}
                          height={30}
                          src="https://i.ibb.co/t2X72fS/cat4-25x25-crop-center.jpg"
                          alt=""
                        />
                        <span>Fruits</span>
                      </div>
                      <div className="hover:bg-gray-100 flex items-center gap-2 hover:cursor-pointer pl-4 py-2">
                        <Image
                          width={30}
                          height={30}
                          src="https://i.ibb.co/8dQ7hbr/cat1-25x25-crop-center.jpg"
                          alt=""
                        />
                        <span>Fruits</span>
                      </div>
