    ...
    return (
        <div className="py-2 md:py-1.5 primary-bg-color">
            <div className="flex flex-col md:flex-row justify-between items-center md:mx-10">
                ...
                <p className="text-white text-center text-xs md:text-sm font-normal">Get Special Deal today! Get 3 products for 2. Limited offer.
                <Link href="/products/all-products"> <a className="underline">Read More</a></Link>   
                </p>
