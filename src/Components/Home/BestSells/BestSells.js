        ...
        <div className="container mx-auto px-10 pt-10">
            <div className="flex justify-between pb-5">
                <div>
                    ...
                    <h1 className="text-3xl font-bold">Daily Best Sells</h1>
                </div>
                <div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 md:grid-cols-5 gap-4">
                <div>
                    <div style={{ backgroundImage: `url('https://i.ibb.co/cc0jgvk/banner-4.png')`, height: "26rem" }} className="dbs-style   max-w-sm   rounded-lg border-1  ">
