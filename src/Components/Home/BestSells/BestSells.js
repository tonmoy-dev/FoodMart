...
import bsLeaf from "./Images/bsell-back.png"
    ...
    return (
        <div className="container mx-auto px-10 pt-10">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 md:grid-cols-5 gap-4">
                ...
                <div>
                    <div style={{ backgroundImage: "url('./Images/bsell-back.png')" }} className=" max-w-sm bg-url(${bsLeaf})  bg-green rounded-lg shadow-md dark:bg-green-800 dark:border-gray-700">

                        {/* <Image className="p-8 rounded-t-lg" src={bsLeaf} alt="product image" /> */}
