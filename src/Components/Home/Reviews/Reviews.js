            ...
            <div className={reviewStyle.containers}>
              ...
              <div>
                <p className={reviewStyle.reviewdetails}>
                  {" "}
                  <b className={reviewStyle.qoute}>“</b> Quis eiusmod aliquip
                  laborum non anim culpa Lorem mollit ut non nulla dolor mollit
                  aliqua. Nisi velit consectetur sunt quis officia enim aliqua
                  occaecat ullamco. Ex labore ad nisi pariatur eu culpa et
                  reprehenderit.dolor mollit aliqua. Nisi velit consectetur sunt
                  quis officia enim aliqua occaecat ullamco. Ex labore ad nisi
                  pariatur eu culpa et reprehenderit.{" "}
