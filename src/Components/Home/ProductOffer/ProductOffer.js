  ...
  return (
    <div className="py-10 mx-4 md:mx-8 overflow-hidden">
      ...
      <div className="md:flex gap-6">
        <div className="bgOffer flex justify-start items-center h-56 overflow-hidden md:w-1/2 rounded-lg shadow-md">
          <div className="p-2 md:px-6 md:py-6 w-2/3 overflow-hidden">
            <p className="text-sm text-green-500 capitalize">Prod of India</p>
            <a
              href="#"
            ...
            <Link href="/products/all-products">
              <a className="text-green-500 transition font-semibold uppercase">
                Buy Now
              </a>
            </Link>
          </div>
        </div>
        <div className="bgOfferT flex justify-start items-center mt-4 md:mt-0  h-56 overflow-hidden md:w-1/2 rounded-lg shadow-md">
          <div className="p-2 md:px-6 md:py-6 w-2/3 overflow-hidden">
            <p className="text-sm text-green-500 capitalize">Winter Foods</p>
