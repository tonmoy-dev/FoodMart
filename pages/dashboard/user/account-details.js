            ...
            <div className="py-10 px-8 md:px-16 mt-6 text-left bg-white shadow-lg  rounded-lg">
                ...
                <div className="mt-4">
                    <p className="text-sm font-bold text-gray-600">
                        ...
                        <a
                            href="#"
                            className="text-sm hover:text-sm pl-1 text-green-600 hover:text-green-800 hover:underline"
                        >
                            Register
                        </a>
                    </p>
                ...
                <form action="">
                    <div className="mt-4">
                        ...
                        <div className="flex items-baseline justify-between">
                            <button className="px-12 py-3 mt-4 text-white bg-green-600 rounded-lg hover:bg-green-700">
                                Sign up
                            </button>
                        </div>
                    </div>
